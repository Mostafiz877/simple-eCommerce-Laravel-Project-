		...
		<div class="container">
			<div class="cart-table">
				<table>
					...
					<tbody>
						...
						@forelse($cart_items as $cart_item)
							...
							<td class="product-col">
								...
								<div class="pc-title">
									<img src="{{asset('uploads/product_photos')}}/{{App\Product::find($cart_item->product_id)->product_image}}" alt="Not found" width="80px">
					...
					<td colspan="4" align="center">You have no Cart</td>
