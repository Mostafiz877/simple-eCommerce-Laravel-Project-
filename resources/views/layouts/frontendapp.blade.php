    ...
    <header class="header-section header-normal">
        <div class="container-fluid">
            ...
            <div class="header-right">
                <a href="{{url('cart')}}" class="card-bag"><img src="{{asset('frontend_assets/img/icons/bag.png')}}" alt="not found"><span>{{ App\Cart::where('customer_ip',$_SERVER['REMOTE_ADDR'])->count()}}</span></a>


                <a href="#" class="search"><img src="{{asset('frontend_assets/img/icons/search.png')}}" alt="not found"></a>
            </div>
            <!-- site menu -->
            <ul class="main-menu">
                ...
                <li><a style="color:black;" href="{{url('category/wise/product')}}/{{$menu->id}}">{{$menu->category_name}}</a></li>
                @endforeach
